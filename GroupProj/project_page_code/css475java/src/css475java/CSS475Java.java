...
/**
 This class instantiates the psudo browser environment to facilitate an interface with
 the SQL DB
 */
    ...
    public Browser() {
        ...
        webEngine.getLoadWorker().stateProperty().addListener((ov, oldState, newState)-> {
            if (newState == State.SUCCEEDED) {
                ((JSObject)webEngine.executeScript("window")).setMember("app", new JSInterface());
            }
        });
